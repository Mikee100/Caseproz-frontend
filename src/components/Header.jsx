...
const SHOP_MEGA_SECTIONS = [
    {
        ...
        items: [
            { label: 'All Audio Products', path: '/category/audio-headphones' },
            { label: 'Earbuds & In-ear', path: '/category/audio-headphones' },
            { label: 'Over-ear Headphones', path: '/category/audio-headphones' },
            { label: 'Bluetooth Speakers', path: '/category/audio-headphones' },
        ],
    },
    {
        title: 'Power & Charging',
        items: [
            { label: 'Power Banks', path: '/category/power-solar' },
            { label: 'Chargers', path: '/category/accessories' },
            { label: 'Cables & Adapters', path: '/category/accessories' },
            { label: 'Portable Power Stations', path: '/category/power-solar' },
        ],
    },
    {
        title: 'Accessories',
        items: [
            ...
            { label: 'Cables & Adapters', path: '/category/accessories' },
            { label: 'Charging Solutions', path: '/category/accessories' },
            { label: 'Phone Accessories', path: '/category/phones-tablets' },
        ],
    },
    {
        title: 'Top Brands',
        items: [
            { label: 'Anker', path: '/brand/anker' },
            { label: 'Soundcore', path: '/brand/soundcore' },
            { label: 'All Brands', path: '/search?q=brands' },
        ],
    },
    {
